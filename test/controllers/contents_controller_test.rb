...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { book_id: @content.book_id, name: @content.name } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { book_id: @content.book_id, name: @content.name } }
